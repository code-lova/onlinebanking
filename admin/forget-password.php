...
<!-- Mirrored from codescandy.com/dashui/pages/forget-password.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Aug 2021 21:21:50 GMT -->
<head>
    <!-- Required meta tags -->
<meta charset="utf-8">
...
<link rel="stylesheet" href="assets/css/theme.min.css">
    <title>Forget Password Admin | Dash Ui</title>
  </head>
            ...
            <div class="card-body p-6">
              <div class="mb-4">
                <a href="index"><img
                    ...
                    class="mb-2" alt=""></a>
                <p class="mb-6">Don't worry, we'll send you an email to reset
                  your
                  password.</p>
              </div>
              <!-- Form -->
              <form>
                ...
                <!-- Button -->
                <div class="mb-3">
                  <button type="submit" name="pass_reset_btn" class="btn btn-primary btn-block">
                    Reset Password
                  </button>
                </div>
