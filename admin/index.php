...
<!-- Mirrored from codescandy.com/dashui/pages/sign-in.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Aug 2021 21:21:48 GMT -->
<head>
    <!-- Required meta tags -->
<meta charset="utf-8">
...
<link rel="stylesheet" href="assets/css/theme.min.css">
    <title>Admin Login | Dash Ui </title>
  </head>
          ...
          <div class="card smooth-shadow-md">
            ...
            <div class="card-body p-6">
              ...
              <?php  
                    ...
                    {
                        echo '<div class="alert alert-danger alert-left-bordered border-danger alert-dismissible d-flex align-items-center p-md-4 mb-2 fade show" role="alert"> <i class="gd-alert icon-text text-danger mr-2"></i>
                            ' .$_SESSION['status'].'</div>';
              ...
              <form action="admin_login.php" method="post">
                ...
                <div class="mb-3">
                  ...
                  <input type="email" id="email" class="form-control"
                    name="email_signin" placeholder="Email address here" required="">
                </div>
                <!-- Password -->
                <div class="mb-3">
                  <label for="password" class="form-label">Password</label>
                  <input type="password" id="password" class="form-control"
                    name="password_signin" placeholder="**************" required="">
                </div>
                <!-- Checkbox -->
                ...
                <div>
                  <!-- Button -->
                  <button type="submit" name="adminlogin_btn" class="btn btn-primary btn-block">Login</button>

                 
                    <div>
                      <a href="forget-password" class="text-inherit
...
<!-- Mirrored from codescandy.com/dashui/pages/sign-in.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Aug 2021 21:21:49 GMT -->
</html>