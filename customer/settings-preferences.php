                                        ...
                                        <form action="" method="post">
                                            <div class="row">
                                                <div class="mb-3 col-6">
                                                    <label class="me-sm-2">Default Currency</label>
                                            ...
                                            <div class="row col-6">
                                                <div class="mb-3 mb-0">
                                                    <label class="toggle">
                                                        ...
                                                        <span class="toggle-label">I send or receive Money</span>
                                                    </label>
                                                    <label class="toggle">
                                                        <input class="toggle-checkbox" type="checkbox" checked>
                                                        <div class="toggle-switch"></div>
                                                        <span class="toggle-label">I am debited for Transactions</span>
                                                    </label>
                                                    <label class="toggle">
                                                        <input class="toggle-checkbox" type="checkbox" checked>
                                                        <div class="toggle-switch"></div>
                                                        <span class="toggle-label">Message from Banks</span>
                                                    </label>
                                                </div>
